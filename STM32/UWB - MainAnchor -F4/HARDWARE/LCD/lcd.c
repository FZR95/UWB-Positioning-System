 ...
 * @brief  Set cursor
 *
 * @param  xpos  Point on x axis
 * @param  ypos  Point on y axis
 */
 ...
 *
 * @brief  Adjust SSD1963 back light brightness
 *
 * @param  pwm level( 0-100 )
 */
 ...
 *
 * @param  dir 0: vertical, 1: horizental
 */
 ...
 * @fn LCD_Set_Window()
 *
 * @brief  Set a draw region where data will wrap automatically.
 *
 * @param  sx  Start point of x axis
 * @param  sy  Start point of y axis
 * @param  width  Length on x axis
 * @param  height Length on y axis
 */
...
void LCD_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1;		  //PB1 推挽输出,控制背光 LCD_BL
 ...
 * @fn LCD_Clear()
 *
 * @brief  Fill whole screen with a single color.
 *
 * @param  color RGB565
 */
 ...
 * @fn LCD_Fill()
 *
 * @brief  Fill a region with a single color.
 *
 * @param  sx  Start point of x axis
 * @param  sy  Start point of y axis
 * @param  ex  End point of x axis
 * @param  ey  End point of y axis
 * @param  color RGB565
 */
 ...
 * @fn LCD_Color_Fill()
 *
 * @brief  Fill a region with a color array.
 *
 * @param  sx  Start point of x axis
 * @param  sy  Start point of y axis
 * @param  ex  End point of x axis
 ...
 * @fn LCD_DrawLine()
 *
 * @brief  Draw a line with a single color.
 *
 * @param  x1  Start point of x axis
 * @param  y1  Start point of y axis
 * @param  x2  End point of x axis
 * @param  y2  End point of y axis
 * @param  POINT_COLOR Needed first
 */
 ...
 *
 * @brief  Draw a rectangle border with a single color.
 *
 * @param  x1  Start point of x axis
 * @param  y1  Start point of y axis
 * @param  x2  End point of x axis
 ...
 * @fn LCD_Draw_Circle()
 *
 * @brief  Draw a circle border with a single color.
 *
...
{
	unsigned char i, j;
	unsigned char sfill = 0;
	unsigned char efill = 0;
	unsigned int bgc, pc;
	LCD_Draw_Circle(x0, y0, r);
	pc = POINT_COLOR;
	POINT_COLOR = BACK_COLOR;
	bgc = LCD_ReadPoint(x0, y0);
	for (i = y0 - r; i < y0 + r + 1; i++)
	{
		for (j = x0 - r; j < x0 + r + 1; j++)
		{
			if (LCD_ReadPoint(j, i) != bgc)
			{
				if (sfill)
				{
					efill = j;
 ...
 * @fn LCD_ShowChar()
 *
 * @brief  Draw a char with a single color.
 *
 * @param  x  	Position on x axis
 * @param  y  	Position on y axis
 * @param  num  Which char ( " "--->"~" )
 * @param  size Size of chars ( 12/16/24 )
 ...
 * @fn LCD_ShowNum()
 *
 * @brief  Show a cluster of number with a single color.
 *
 * @param  x  	Position on x axis
 * @param  y  	Position on y axis
 * @param  num 	The number will be show
 ...
 * @fn LCD_ShowxNum()
 *
 * @brief  Show a cluster of number with a single color and display 0 on high level.
 *
 * @param  x  	Position on x axis
 * @param  y  	Position on y axis
 * @param  num 	The number will be show
...
/*! ------------------------------------------------------------------------------------------------------------------
 * @fn LCD_ShowNum_Float()
 *
 * @brief  Show a cluster of number with a single color float supported. No longer than 10 by default.
 *
 * @param  x  	Position on x axis
 * @param  y  	Position on y axis
 * @param  num 	The number will be show
 * @param  len	The length of the number
 * @param  size Size of chars ( 12/16/24 )
 * @param  trans 1 - display transcluently
 * @param  POINT_COLOR Needed first
 */
void LCD_ShowNum_Float(u16 x, u16 y, double num, u8 len, u8 size, char trans)
{
	char numstr[10];
	sprintf(numstr,"%3.2f",num);
	if (trans)
		LCD_ShowString_Transcluent(x, y, 8 * len, size, size, numstr);
	else
		LCD_ShowString(x, y, 8 * len, size, size, numstr);
}

/*! ------------------------------------------------------------------------------------------------------------------
 * @fn LCD_ShowString()
 *
 * @brief  Show a string with a single color.
 *
 * @param  x  			Position on x axis
 * @param  y  			Position on y axis
...
/*! ------------------------------------------------------------------------------------------------------------------
 * @fn LCD_ShowString_Transcluent()
 *
 * @brief  Show a string with a single color and does not cover the background.
 *
 * @param  x  			Position on x axis
 * @param  y  			Position on y axis
 * @param  width 		Region width
 ...
 * @param  POINT_COLOR 	Needed first
 */
void LCD_ShowString_Transcluent(u16 x, u16 y, u16 width, u16 height, u8 size, u8 *p)
{
	u8 x0 = x;
	width += x;
	height += y;
